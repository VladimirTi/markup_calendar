...
- [DEMO LINK](https://vitalya2626.github.io/layout_calendar/)
- [TEST REPORT LINK](https://vitalya2626.github.io/layout_calendar/report/html_report/)
...
- Each day is a grey (`#eee`) `100px` Squared (including 1px black border)
...
- Implement `start-day` modifier with `mon`, `tue`, `wed`, `thu`, `fri`, `sat` and `sun` values
...
- Add a modifier `month-length` with values 28, 29, 30 and 31 (use `@for`)
